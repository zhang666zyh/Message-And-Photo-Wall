...
export const cardColor = [
  ...
  "rgba(252,175,162,0.31)"
]

export const cardColorOne = [
  "rgb(255,227,148)",
  "rgb(146,230,245)",
  "rgb(168,237,138)",
  "rgb(202,167,247)",
...
export const portrait = [
  ...
  'linear-gradient(180deg,#DFA1FF 8%,#9A36F0 100%)',
  ...
  'linear-gradient(180deg,#FFED48 8%,#FD9E16 100%)',
  'linear-gradient(180deg,#FFDC83 0%,#F8881B 100%)',
